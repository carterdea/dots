---
name: agent-browser
description: Browser automation CLI for AI agents. Use when the user says "agent-browser", "agent browser", "use agent browser", "browse to", or needs to interact with websites, including navigating pages, filling forms, clicking buttons, taking screenshots, extracting data, testing web apps, or automating any browser task. This is NOT the Chrome MCP extension -- it is a standalone CLI tool called agent-browser. Triggers include requests to "open a website", "fill out a form", "click a button", "take a screenshot", "scrape data from a page", "test this web app", "login to a site", "automate browser actions", or any task requiring programmatic web interaction.
