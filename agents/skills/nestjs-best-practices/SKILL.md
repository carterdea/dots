...
description: NestJS best practices and architecture patterns for production applications. Use when writing, reviewing, or refactoring NestJS code covering modules, dependency injection, security, and performance.
license: MIT
metadata:
  author: Kadajett
  version: "1.1.0"
