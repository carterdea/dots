...
- Default examples should be PostgreSQL-compatible unless the request names another dialect.
...
- Translate data types, identity columns, indexes, timestamp defaults, and migration syntax to the chosen database before presenting final DDL.
...
```sql
-- Auto-increment / identity (PostgreSQL, SQL standard)
