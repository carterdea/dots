---
name: security-audit
description: Security audit code for vulnerabilities. Use when asked to review code security, check vulnerabilities, find secrets, audit dependencies, or trace injection, auth/access-control, crypto, or business-logic risks.
---
